...
cd translator
cp ../OneLife/scripts/skps2010Scripts/onlyapplysettings.py .
cp ../OneLife/scripts/skps2010Scripts/onlytranslatormenu.py .
cp ../OneLife/scripts/skps2010Scripts/onlytranslatorobject.py .
cp ../OneLife/scripts/skps2010Scripts/onlytranslatorimage.py .
cp OneLife/scripts/skps2010Scripts/translator.py .

cd ..
cp OneLife/scripts/skps2010Scripts/main.bat
