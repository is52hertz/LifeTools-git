...
// lineImportCache
            ...
            if( !imported ) {
                ...
                char *message = autoSprintf( translate("Flfailed_to_import_png_from___")
// Failed to import PNG from:##
                                             "%s", fullFileName );
...
// lineImportCache
        ...
        *( mOverlayFlip.getLastElement() ) = 
        ...
        setSignal( translate("sprite_trim_editor") );
        }
// spriteTrimEditor
    else if( inTarget == &mObjectEditorButton ) {
        setSignal( translate("object_editor") );
        }
// objectEditor
