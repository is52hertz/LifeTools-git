...
EditorObjectPage::EditorObjectPage()
    ...
    mCheckboxNames[0] = translate("containable");
    mCheckboxNames[1] = translate("permanent");
    mCheckboxNames[2] = translate("person");
    ...
    mClothingCheckboxNames[0] = translate("bottom");
    mClothingCheckboxNames[1] = translate("backpack");
    mClothingCheckboxNames[2] = translate("shoe");
    mClothingCheckboxNames[3] = translate("tunic");
    mClothingCheckboxNames[4] = translate("hat");
