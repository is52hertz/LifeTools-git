...
EditorAnimationPage::EditorAnimationPage()
    ...
    addKeyClassDescription( &mKeyLegend, translate("r_click_or_arrows"), 
    // R-click/arrows
// or = /
                            translate("move_layer_rot_anchor") );
    addKeyClassDescription( &mKeyLegend, translate("ctr_or_shft"), translate("bigger_jumps") );
    addKeyDescription( &mKeyLegend, 'f', translate("flip_horizontally") );
    addKeyDescription( &mKeyLegend, 'h', translate("hide_or_show_ui") );
    // Hide/show UI
    
    addKeyClassDescription( &mKeyLegendB, translate("r_click"), translate("copy_animations") );
    // R-Click
    }
