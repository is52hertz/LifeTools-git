...
EditorExportPage::EditorExportPage()
        : mObjectPicker( &objectPickable, +410, 90 ),
          ...
          mExportButton( mainFont, 210, -260, "Export-导出" ),
          mClearButton( mainFont, -450, -260, "清除" ),
          mCopyHashButton( smallFont, 400, -290, "复制哈希值" ),
          mCopyIDListButton( smallFont, -300, -230, "复制ID列表" ),
          mPasteIDListButton( smallFont, -300, -290, "粘贴ID列表" ),
